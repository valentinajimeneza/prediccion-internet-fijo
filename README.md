...
## 👥 ¿A quién va dirigido y qué valor aporta?
Esta herramienta está pensada para tres tipos de usuarios:

- **Operadores e ISP** → estimar qué tecnología predomina según la región, el
  segmento y las velocidades, como apoyo para decidir **dónde y qué desplegar**.
- **Analistas y entes reguladores** (p. ej. la CRC) → estudiar la **brecha digital**
  y la calidad del servicio por región, y detectar inconsistencias en los reportes.
- **Investigadores y estudiantes** → entender, de forma simple, **qué factores
  determinan** el tipo de acceso a internet fijo en Colombia.

**Valor:** convierte datos públicos abiertos en una predicción inmediata y
comprensible, sin necesidad de procesar manualmente las tablas oficiales.
